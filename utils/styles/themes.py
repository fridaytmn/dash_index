BOOTSTRAP = "/static/style/bootstrap/5.3.1/dist/css/bootstrap.min.css"

GRID = "/static/style/bootstrap/5.3.1/dist/css/bootstrap-grid.min.css"  # noqa

_BOOTSWATCH_BASE = "/static/style/bootswatch/5.3.1/dist"
